...
public class VehicleDbHelper {
	...
	protected String getVehicleIdByModel(Connection connection, String model) throws CarSystemException {
		String id = null;
		if(connection != null) {
			PreparedStatement preparedStatement = null;
	...
	protected Vehicle getVehicleIById(Connection connection, String id) throws CarSystemException {
	...
	public void edit(Connection connection,Vehicle vehicle) throws CarSystemException {
		...
		try {
			...
			System.out.println("******"+vehicle.getCreated_by());
			System.out.println("******"+vehicle.getCreated_time());
