...
public class DbHelper {
	String result = "";
	String SELECT_ALL_EMPLOYEES_QUERY = "select * from employeetable1";
	
	String SELECT_EMPLOYEE_BY_ID_QUERY = "select * from employeetable1 where id=?";
	
	String SELECT_EMPLOYEE_BY_NAME_QUERY = "select * from employeetable1 where name=?";
	
	String DELETE_EMPLOYEE_BY_ID_QUERY = "delete from employeetable1 where id=?";
	
	String CREATE_EMPLOYEE_QUERY = "insert into employeetable1(id,name,email,dob,address,salary) values(?,?,?,?,?,?)";
